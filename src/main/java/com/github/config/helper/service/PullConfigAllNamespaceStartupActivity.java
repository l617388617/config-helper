package com.github.config.helper.service;
 ...
 */
public class PullConfigAllNamespaceStartupActivity implements StartupActivity.Background {

    private static final Logger log = Logger.getInstance(PullConfigAllNamespaceStartupActivity.class);
