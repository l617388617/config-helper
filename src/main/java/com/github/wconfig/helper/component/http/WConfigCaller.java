package com.github.wconfig.helper.component.http;
 ...
 */
public class WConfigCaller extends BaseHttpCaller {

    private static final Logger log = Logger.getInstance(BaseHttpCaller.class);

    public static final WConfigCaller INSTANCE = new WConfigCaller();
